...
<footer className="bg-blue-900 text-white pt-12 pb-6">
  <div className="container mx-auto px-4">
    <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
      ...
      {/* For Job Seekers */}
      <div>
        <h4 className="font-bold mb-4 text-orange-300">For Job Seekers</h4>
        <ul className="space-y-2">
          <li><a href="#" className="text-blue-100 hover:text-orange-300">Browse Jobs</a></li>
      ...
      {/* For Employers */}
      <div>
        <h4 className="font-bold mb-4 text-orange-300">For Employers</h4>
        <ul className="space-y-2">
      ...
      {/* Contact Info */}
      <div>
        <h4 className="font-bold mb-4 text-orange-300">Contact Us</h4>
        <ul className="space-y-3 text-blue-100">
          <li className="flex items-start">
            <svg className="w-5 h-5 mr-2 mt-0.5 text-orange-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {/* <div className="border-t border-blue-700 pt-6 mt-6">
      <div className="flex flex-col md:flex-row justify-between items-center">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <a href="#" className="text-blue-100 hover:text-orange-300 text-sm">Privacy Policy</a>
          <a href="#" className="text-blue-100 hover:text-orange-300 text-sm">Terms of Service</a>
          <a href="#" className="text-blue-100 hover:text-orange-300 text-sm">Cookie Policy</a>
          <a href="#" className="text-blue-100 hover:text-orange-300 text-sm">Sitemap</a>
        </div>
      </div>
    </div> */}
  </div>
